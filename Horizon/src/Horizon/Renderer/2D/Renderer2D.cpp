...
namespace Horizon
{
	...
	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const glm::vec4& color)
	{
		...
		s_V2Data.QuadVertexBufferPointer->Position = position;
		...
		s_V2Data.QuadVertexBufferPointer->Position = {position.x + size.x, position.y, 0.0f};
		s_V2Data.QuadVertexBufferPointer->Color = color;
		s_V2Data.QuadVertexBufferPointer->TexCoord = { 0.0f, 0.0f };
		s_V2Data.QuadVertexBufferPointer->TexIndex = texIndex;
		s_V2Data.QuadVertexBufferPointer->TilingFactor = tilingFactor;
		...
		s_V2Data.QuadVertexBufferPointer->Position = { position.x + size.x, position.y + size.y, 0.0f };
		s_V2Data.QuadVertexBufferPointer->Color = color;
		s_V2Data.QuadVertexBufferPointer->TexCoord = { 0.0f, 0.0f };
		s_V2Data.QuadVertexBufferPointer->TexIndex = texIndex;
		s_V2Data.QuadVertexBufferPointer->TilingFactor = tilingFactor;
		...
		s_V2Data.QuadVertexBufferPointer->Position = { position.x, position.y + size.y, 0.0f };
		s_V2Data.QuadVertexBufferPointer->Color = color;
		s_V2Data.QuadVertexBufferPointer->TexCoord = { 0.0f, 0.0f };
		s_V2Data.QuadVertexBufferPointer->TexIndex = texIndex;
		s_V2Data.QuadVertexBufferPointer->TilingFactor = tilingFactor;
		...
		s_V2Data.TextureShader->SetMat4("u_Transform", transform);
		s_V2Data.QuadVertexArray->Bind();
		RenderCommand::DrawIndexed(s_V2Data.QuadVertexArray);*/
	}
	...
	{
		s_V2Data.TextureShader->SetFloat4("u_Color", tintColor);// or { 0.2f, 0.3f, 0.8f, 0.5f }
		s_V2Data.TextureShader->SetFloat("u_TilingFactor", tilingFactor);
