...
{
	m_CheckboardTexture = Horizon::Texture2D::Create("assets/textures/Checkerboard.png");
};
...
void Sandbox2D::OnUpdate(Horizon::Timestep ts)
{
	...
	Horizon::Renderer2D::DrawQuad( { 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckboardTexture);
